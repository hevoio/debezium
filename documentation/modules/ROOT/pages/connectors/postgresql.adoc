...
All up-to-date differences are tracked in a test suite link:https://github.com/hevoio/debezium/blob/main/debezium-connector-postgres/src/test/java/io/debezium/connector/postgresql/DecoderDifferences.java[Java class].
