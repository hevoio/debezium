...
A self-contained example https://github.com/hevoio/debezium-examples/tree/main/ui-demo[ui-demo] is available, which is included under https://github.com/hevoio/debezium-examples[debezium-examples] on Github.  The ui-demo includes a docker-compose file which brings up several sources with data as well as the UI. Please refer to the https://github.com/hevoio/debezium-examples/tree/main/ui-demo[README file] for more details on running the Debezium ui-demo.
