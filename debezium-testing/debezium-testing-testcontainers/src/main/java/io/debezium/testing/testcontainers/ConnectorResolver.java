...
public class ConnectorResolver {
    ...
    static {
        ...
        tmp.put("io.debezium.mysql.cj.jdbc.Driver", "io.debezium.connector.mysql.MySqlConnector");
        tmp.put("io.debezium.mysql.jdbc.Driver", "io.debezium.connector.mysql.MySqlConnector");
